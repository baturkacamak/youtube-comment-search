(() => {
    ...
    let f = {
        get(e, t, r) {
            ...
            return v(e[t])
        }, set: (e, t, r) => (e[t] = r, !0), has: (e, t) => e instanceof IDBTransaction && ("done" === t || "store" === t) || t in e
    };
    ...
    f = (e => ({...e, get: (t, r, n) => w(t, r) || e.get(t, r, n), has: (t, r) => !!w(t, r) || e.has(t, r)
    }))(f);
    e(o)(fetch, {
        retries: 100,
    ...
    chrome.runtime.onInstalled.addListener((async() => {
        ...
        var r, n;
        "YCS_SET_BADGE" === (null == e ? void 0 : e.type) && (chrome.action.setBadgeText({
        ...
        if ("YCS_CACHE_STORAGE_GET" === (null == e ? void 0 : e.type) && (null == e ? void 0 : e.body) && e.body.videoId) {
            ...
            if (null == t || null === (o = t.tab) || void 0 === o ? void 0 : o.id)
                if (n) chrome.tabs.sendMessage(null === (i = t.tab) || void 0 === i ? void 0 : i.id, {
                    type: "YCS_CACHE_STORAGE_GET_SEND",
                    body: n.body
                });
                else {
                    var a;
                    (await chrome.storage.local.get("autoload")).autoload && chrome.tabs.sendMessage(null === (a = t.tab) || void 0 === a ? void 0 : a.id, {
                        type: "YCS_AUTOLOAD"
                    })
                }
        }
